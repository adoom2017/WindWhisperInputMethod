# Windows TSF validation

The Windows adapter is built as `fy_tsf.dll` (x64) and exposes
...
Install the MSI as administrator, then enable WindWhisper under **Settings >
Time & language > Language & region > Chinese > Language options**. Verify
